...
var ASM_CONSTS = {
  101752: () => { if (document.fullscreenElement) return 1; },  
 101798: () => { return Module.canvas.width; },  
 101830: () => { return parseInt(Module.canvas.style.width); },  
 101878: () => { document.exitFullscreen(); },  
 101905: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 101978: () => { if (document.fullscreenElement) return 1; },  
 102024: () => { return Module.canvas.width; },  
 102056: () => { return screen.width; },  
 102081: () => { document.exitFullscreen(); },  
 102108: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 102241: () => { return window.innerWidth; },  
 102267: () => { return window.innerHeight; },  
 102294: () => { if (document.fullscreenElement) return 1; },  
 102340: () => { return Module.canvas.width; },  
 102372: () => { return parseInt(Module.canvas.style.width); },  
 102420: () => { if (document.fullscreenElement) return 1; },  
 102466: () => { return Module.canvas.width; },  
 102498: () => { return screen.width; },  
 102523: () => { return window.innerWidth; },  
 102549: () => { return window.innerHeight; },  
 102576: () => { if (document.fullscreenElement) return 1; },  
 102622: () => { return Module.canvas.width; },  
 102654: () => { return screen.width; },  
 102679: () => { document.exitFullscreen(); },  
 102706: () => { if (document.fullscreenElement) return 1; },  
 102752: () => { return Module.canvas.width; },  
 102784: () => { return parseInt(Module.canvas.style.width); },  
 102832: () => { document.exitFullscreen(); },  
 102859: ($0) => { Module.canvas.style.opacity = $0; },  
 102897: () => { return screen.width; },  
 102922: () => { return screen.height; },  
 102948: () => { return window.screenX; },  
 102975: () => { return window.screenY; },  
 103002: () => { return window.devicePixelRatio; },  
 103038: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 103091: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 103142: () => { Module.canvas.style.cursor = 'none'; },  
 103179: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 103435: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 103486: () => { if (document.pointerLockElement) return 1; },  
 103533: () => { if (document.fullscreenElement) return 1; },  
 103579: () => { return window.innerWidth; },  
 103605: () => { return window.innerHeight; }
};
